...
namespace FitnessON.Model.DBContext
{
    public class DBInitializer : DropCreateDatabaseIfModelChanges<FitnessDB>
    {
        ...
        */
        ...
        {
            context.Leases.Add(new Lease { Id = 1, Card_Id = 3, MixLeases_Id = 1, StartValidity = "1559415037", EndValidity = "1562007037", NumberOfEntries = 10,  inUse = false });
            context.Leases.Add(new Lease { Id = 2, Card_Id = 3, MixLeases_Id = 3, StartValidity = "1564685437", EndValidity = "1567363837", NumberOfEntries = 10, inUse = false });
            context.Leases.Add(new Lease { Id = 3, Card_Id = 1, MixLeases_Id = 2, StartValidity = "0", EndValidity = "0", NumberOfEntries = 20, inUse = false });
        }
        /*
